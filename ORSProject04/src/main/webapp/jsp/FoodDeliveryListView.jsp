<%@page import="com.sunilos.p4.bean.FoodDeliveryBean"%>
s
...
Iterator<FoodDeliveryBean> it = list.iterator();
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-bookmark-star-fill me-2"></i> Food Delivery List
			</h5>
		...
		<form action="<%=ORSView.FOOD_DELIVERY_LIST_CTL%>" method="POST">
			...
			<div
				...
				<input type="text" name="name" class="form-control form-control-sm"
					style="max-width: 220px;" placeholder="Search by customerName"
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getRestaurantName()%></td>
