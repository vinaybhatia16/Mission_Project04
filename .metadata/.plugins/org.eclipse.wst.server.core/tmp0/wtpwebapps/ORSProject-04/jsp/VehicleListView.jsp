		...
		<form action="<%=ORSView.VEHICLE_LIST_CTL%>" method="post">
			...
			<table style="width: 100%">
				...
				<tr>
					...
					<td align="center"><label> <b>Vehicle Name :</b>

					</label> <input type="text" name="vehicleName"
						placeholder="Enter Vehicle Name"
						value="<%=ServletUtility.getParameter("vehicleName", request)%>">

						&emsp; <label> <b>Company :</b>

					</label> <input type="text" name="company" placeholder="Enter Company"
			...
			<table border="1" style="width: 100%; border: groove;">
				...
				<tr>
					...
					<td style="text-align: center"><%=bean.getVehicleName()%></td>

					<td style="text-align: center"><%=bean.getModel()%></td>

					<td style="text-align: center"><%=bean.getCompany()%></td>
